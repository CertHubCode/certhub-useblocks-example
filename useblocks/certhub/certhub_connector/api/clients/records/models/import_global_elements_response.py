...
if TYPE_CHECKING:
    from ..models.import_global_elements_response_error_details_item import (
        ImportGlobalElementsResponseErrorDetailsItem,
    )


T = TypeVar("T", bound="ImportGlobalElementsResponse")


@_attrs_define
class ImportGlobalElementsResponse:
    """Response model for import operations

    Attributes:
        successful_imports (int | Unset): Number of successfully imported global elements Default: 0.
        failed_imports (int | Unset): Number of failed imports Default: 0.
        error_details (list[ImportGlobalElementsResponseErrorDetailsItem] | Unset): Details of any failed imports
    """

    successful_imports: int | Unset = 0
    failed_imports: int | Unset = 0
    error_details: list[ImportGlobalElementsResponseErrorDetailsItem] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        error_details: list[ImportGlobalElementsResponseErrorDetailsItem] | Unset = (
            UNSET
        )
        if _error_details is not UNSET:
            ...
            for error_details_item_data in _error_details:
                error_details_item = (
                    ImportGlobalElementsResponseErrorDetailsItem.from_dict(
        ...
        import_global_elements_response = cls(
            successful_imports=successful_imports,
            failed_imports=failed_imports,
            error_details=error_details,
        )

        import_global_elements_response.additional_properties = d
        return import_global_elements_response
