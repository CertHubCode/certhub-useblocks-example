...
T = TypeVar("T", bound="PaginatedTraceList")


@_attrs_define
class PaginatedTraceList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        paginated_trace_list.additional_properties = d
        return paginated_trace_list
