...
T = TypeVar("T", bound="CreateKnowledgeUnitSchemasResponse")


@_attrs_define
class CreateKnowledgeUnitSchemasResponse:
    """Response model for creating multiple knowledge unit schemas

    Attributes:
        data (list[KnowledgeUnitSchema]): Array of successfully created schemas
        skipped_knowledge_topics (list[SkippedKnowledgeTopic] | Unset): Array of skipped knowledge topics with their
            reasons
    """

    data: list[KnowledgeUnitSchema]
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for data_item_data in _data:
            data_item = KnowledgeUnitSchema.from_dict(data_item_data)
        ...
        create_knowledge_unit_schemas_response = cls(
            data=data,
            skipped_knowledge_topics=skipped_knowledge_topics,
        )

        create_knowledge_unit_schemas_response.additional_properties = d
        return create_knowledge_unit_schemas_response
