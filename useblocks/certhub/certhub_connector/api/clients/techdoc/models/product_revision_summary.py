...
T = TypeVar("T", bound="ProductRevisionSummary")


@_attrs_define
class ProductRevisionSummary:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        product_revision_summary.additional_properties = d
        return product_revision_summary
