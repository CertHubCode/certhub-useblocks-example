...
T = TypeVar("T", bound="UpdateKnowledgeUnitSchema")


@_attrs_define
class UpdateKnowledgeUnitSchema:
    """
    Attributes:
    ...
    is_not_editable_for_children: bool | None | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_knowledge_unit_schema = cls(
        ...
        update_knowledge_unit_schema.additional_properties = d
        return update_knowledge_unit_schema
