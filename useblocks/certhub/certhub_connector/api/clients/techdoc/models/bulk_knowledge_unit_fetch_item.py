...
T = TypeVar("T", bound="BulkKnowledgeUnitFetchItem")


@_attrs_define
class BulkKnowledgeUnitFetchItem:
    """A single knowledge unit to resolve in a bulk fetch request.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        bulk_knowledge_unit_fetch_item = cls(
            history_id=history_id,
            version=version,
            latest_approved=latest_approved,
        )

        bulk_knowledge_unit_fetch_item.additional_properties = d
        return bulk_knowledge_unit_fetch_item
