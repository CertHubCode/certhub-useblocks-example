...
T = TypeVar("T", bound="OrderedKnowledgeTopic")


@_attrs_define
class OrderedKnowledgeTopic:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        ordered_knowledge_topic = cls(
            knowledge_topic_id=knowledge_topic_id,
            index=index,
        )

        ordered_knowledge_topic.additional_properties = d
        return ordered_knowledge_topic
