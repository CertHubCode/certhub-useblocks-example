...
if TYPE_CHECKING:
    ...
    from ..models.knowledge_topic_with_traces_data import KnowledgeTopicWithTracesData
    from ..models.knowledge_topic_with_traces_knowledge_topic_schema import (
...
T = TypeVar("T", bound="KnowledgeTopicWithTraces")


@_attrs_define
class KnowledgeTopicWithTraces:
    """
    Attributes:
        ...
        knowledge_topic_schema (KnowledgeTopicWithTracesKnowledgeTopicSchema):
        metadata (TenantMetadata):
        source_schema_id (None | str | Unset):
        data (KnowledgeTopicWithTracesData | Unset):
    ...
    data: KnowledgeTopicWithTracesData | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.audit_info import AuditInfo
        from ..models.external_source_info import ExternalSourceInfo
        from ..models.knowledge_topic_with_traces_data import (
        ...
        knowledge_topic_schema = KnowledgeTopicWithTracesKnowledgeTopicSchema.from_dict(
        ...
        if isinstance(_data, Unset):
            ...
            data = KnowledgeTopicWithTracesData.from_dict(_data)
        ...
        knowledge_topic_with_traces = cls(
            field_id=field_id,
            knowledge_topic_name=knowledge_topic_name,
            type_=type_,
            knowledge_topic_history_id=knowledge_topic_history_id,
        ...
        knowledge_topic_with_traces.additional_properties = d
        return knowledge_topic_with_traces
