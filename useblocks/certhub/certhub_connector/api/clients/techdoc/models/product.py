...
if TYPE_CHECKING:
    ...
    from ..models.product_knowledge_units_item import ProductKnowledgeUnitsItem
    from ..models.product_product_families_item import ProductProductFamiliesItem
...
class Product:
    ...
    Attributes:
        ...
        product_families (list[ProductProductFamiliesItem] | Unset):
        knowledge_units (list[ProductKnowledgeUnitsItem] | Unset):
    ...
    product_families: list[ProductProductFamiliesItem] | Unset = UNSET
    knowledge_units: list[ProductKnowledgeUnitsItem] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _product_families is not UNSET:
            ...
            for product_families_item_data in _product_families:
                product_families_item = ProductProductFamiliesItem.from_dict(
        ...
        if _knowledge_units is not UNSET:
            ...
            for knowledge_units_item_data in _knowledge_units:
                knowledge_units_item = ProductKnowledgeUnitsItem.from_dict(
