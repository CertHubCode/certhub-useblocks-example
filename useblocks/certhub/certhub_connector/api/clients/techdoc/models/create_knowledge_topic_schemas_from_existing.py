...
T = TypeVar("T", bound="CreateKnowledgeTopicSchemasFromExisting")


@_attrs_define
class CreateKnowledgeTopicSchemasFromExisting:
    ...
    Attributes:
        ...
        knowledge_unit_schema_history_id (str | Unset): knowledge unit id to add the knowledge topics Default: ''.
    """

    kt_schema_ids: list[str] | None | Unset = UNSET
    kt_ids: list[str] | None | Unset = UNSET
    include_content: bool | Unset = False
    knowledge_unit_schema_history_id: str | Unset = ""
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        knowledge_unit_schema_history_id = d.pop(
            "knowledge_unit_schema_history_id", UNSET
        )

        create_knowledge_topic_schemas_from_existing = cls(
        ...
        create_knowledge_topic_schemas_from_existing.additional_properties = d
        return create_knowledge_topic_schemas_from_existing
