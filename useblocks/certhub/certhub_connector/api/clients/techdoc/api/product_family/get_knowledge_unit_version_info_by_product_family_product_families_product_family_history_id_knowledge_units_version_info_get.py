...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/product-families/{product_family_history_id}/knowledge-units/version-info".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get knowledge unit version info by product family history ID

     Returns version info for all knowledge units belonging to the product family at the specified
    revision.
