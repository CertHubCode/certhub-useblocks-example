...
T = TypeVar("T", bound="UpdateRecordContext")


@_attrs_define
class UpdateRecordContext:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_record_context.additional_properties = d
        return update_record_context
