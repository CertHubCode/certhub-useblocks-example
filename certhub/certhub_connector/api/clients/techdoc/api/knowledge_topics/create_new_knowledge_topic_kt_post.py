...
from ...models.body_create_new_knowledge_topic_kt_post import (
...
def _get_kwargs(
    *,
    body: BodyCreateNewKnowledgeTopicKtPost,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Create New Knowledge Topic
     ...
     Insert a new knowledge topic.
    A unique `id` will be created and provided in the response.
    We always require a knowledge unit history id to add a new knowledge topic.
