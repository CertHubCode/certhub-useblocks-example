...
def sync_detailed(
    *,
    ...
    """Import Knowledge Unit Schemas

     Import knowledge unit schemas from JSON files

    Args:
        body (ImportRequest): Request model for importing units or schemas
