...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/products/{product_history_id}/knowledge-units".format(
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = FullKnowledgeUnitView.from_dict(response_200_item_data)
...
def sync_detailed(
    ...
    *,
    ...
    """Get knowledge units at product version

     Returns knowledge units at the specific revisions that were associated with the product at the
    requested version. Includes KUs from related product families.
