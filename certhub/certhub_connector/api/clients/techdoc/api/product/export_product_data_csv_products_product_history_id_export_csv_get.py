...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/products/{product_history_id}/export/csv".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Export product data as CSV
     ...
     Exports the product's latest revision as a ZIP of one CSV per Knowledge Topic, grouped into one
    folder per Knowledge Unit.
