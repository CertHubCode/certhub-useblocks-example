...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/product-families/{product_family_history_id}/knowledge-units".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get knowledge units at product family version

     Returns knowledge units at the specific revisions that were associated with the product family at
