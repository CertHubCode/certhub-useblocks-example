...
from ...models.update_product_family import UpdateProductFamily
...
def sync_detailed(
    ...
    *,
    ...
    """Update latest product family revision

     Updates the latest revision of a product family with the provided changes.

    Args:
        product_family_history_id (str): The ID of the product family to update Example:
