...
if TYPE_CHECKING:
    ...
    from ..models.product_fields import ProductFields


T = TypeVar("T", bound="ProductAnalytics")
...
class ProductAnalytics:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        product_fields = self.product_fields.to_dict()
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        product_fields = ProductFields.from_dict(d.pop("product_fields"))
        ...
        product_analytics.additional_properties = d
