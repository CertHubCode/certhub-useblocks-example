...
T = TypeVar("T", bound="CreateKnowledgeTopicSchemaFromExisting")


@_attrs_define
class CreateKnowledgeTopicSchemaFromExisting:
    """Model for creating a schema from existing KT schema or KT
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_knowledge_topic_schema_from_existing = cls(
            kt_schema_id=kt_schema_id,
            kt_id=kt_id,
            include_content=include_content,
        )

        create_knowledge_topic_schema_from_existing.additional_properties = d
        return create_knowledge_topic_schema_from_existing
