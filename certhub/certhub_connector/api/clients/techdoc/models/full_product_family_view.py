...
T = TypeVar("T", bound="FullProductFamilyView")


@_attrs_define
class FullProductFamilyView:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        full_product_family_view.additional_properties = d
        return full_product_family_view
