...
if TYPE_CHECKING:
    ...
    from ..models.slim_knowledge_unit_schema_response import (
        SlimKnowledgeUnitSchemaResponse,
    )
    from ..models.tenant_metadata import TenantMetadata


T = TypeVar("T", bound="SlimLibraryResponse")


@_attrs_define
class SlimLibraryResponse:
    """
    Attributes:
        ...
        knowledge_unit_schemas (list[SlimKnowledgeUnitSchemaResponse] | Unset):
    """
    ...
    knowledge_unit_schemas: list[SlimKnowledgeUnitSchemaResponse] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _knowledge_unit_schemas is not UNSET:
            ...
            for knowledge_unit_schemas_item_data in _knowledge_unit_schemas:
                knowledge_unit_schemas_item = SlimKnowledgeUnitSchemaResponse.from_dict(
                    knowledge_unit_schemas_item_data
                )

                knowledge_unit_schemas.append(knowledge_unit_schemas_item)

        slim_library_response = cls(
            id=id,
            name=name,
            metadata=metadata,
            audit_info=audit_info,
        ...
        slim_library_response.additional_properties = d
        return slim_library_response
