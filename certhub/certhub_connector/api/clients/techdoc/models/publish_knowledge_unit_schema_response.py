...
T = TypeVar("T", bound="PublishKnowledgeUnitSchemaResponse")


@_attrs_define
class PublishKnowledgeUnitSchemaResponse:
    """Response for knowledge unit schema publish operation
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        publish_knowledge_unit_schema_response = cls(
            success=success,
            commit_message=commit_message,
            knowledge_unit_schema=knowledge_unit_schema,
        )

        publish_knowledge_unit_schema_response.additional_properties = d
        return publish_knowledge_unit_schema_response
