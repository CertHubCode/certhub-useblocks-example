...
T = TypeVar("T", bound="CreateKUSchemaLibraryBase")


@_attrs_define
class CreateKUSchemaLibraryBase:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_ku_schema_library_base = cls(
            name=name,
            description=description,
            knowledge_unit_schema_ids=knowledge_unit_schema_ids,
        )

        create_ku_schema_library_base.additional_properties = d
        return create_ku_schema_library_base
