...
T = TypeVar("T", bound="KnowledgeUnitRevisionSummary")


@_attrs_define
class KnowledgeUnitRevisionSummary:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        knowledge_unit_revision_summary = cls(
            id=id,
            name=name,
            version_string=version_string,
            is_latest_approved=is_latest_approved,
        ...
        knowledge_unit_revision_summary.additional_properties = d
        return knowledge_unit_revision_summary
