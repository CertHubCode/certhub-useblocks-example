...
T = TypeVar("T", bound="SlimProductFamilyRef")


@_attrs_define
class SlimProductFamilyRef:
    """Minimal product-family reference: only identity fields, no nested data.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        slim_product_family_ref = cls(
            field_id=field_id,
            product_family_history_id=product_family_history_id,
            name=name,
        )

        slim_product_family_ref.additional_properties = d
        return slim_product_family_ref
