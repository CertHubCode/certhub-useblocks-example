...
if TYPE_CHECKING:
    from ..models.product_revision_summary import ProductRevisionSummary


T = TypeVar("T", bound="ProductHistoryGroup")
...
class ProductHistoryGroup:
    ...
    Attributes:
        ...
        name (str):
        latest_revision (ProductRevisionSummary): Summary of a submission revision for listing purposes
        latest_approved (None | ProductRevisionSummary | Unset):
        revisions (list[ProductRevisionSummary] | Unset):
    ...
    latest_approved: None | ProductRevisionSummary | Unset = UNSET
    revisions: list[ProductRevisionSummary] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.latest_approved, ProductRevisionSummary):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        latest_revision = ProductRevisionSummary.from_dict(d.pop("latest_revision"))

        def _parse_latest_approved(
            data: object,
        ) -> None | ProductRevisionSummary | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                latest_approved_type_0 = ProductRevisionSummary.from_dict(data)

                return latest_approved_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProductRevisionSummary | Unset, data)
        ...
        if _revisions is not UNSET:
            ...
            for revisions_item_data in _revisions:
                revisions_item = ProductRevisionSummary.from_dict(revisions_item_data)

                revisions.append(revisions_item)

        total_revisions = d.pop("total_revisions", UNSET)

        product_history_group = cls(
            product_history_id=product_history_id,
            name=name,
            latest_revision=latest_revision,
        ...
        product_history_group.additional_properties = d
        return product_history_group
