...
T = TypeVar("T", bound="DuplicateKnowledgeTopic")


@_attrs_define
class DuplicateKnowledgeTopic:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        duplicate_knowledge_topic = cls(
            kt_schema_id=kt_schema_id,
            kt_id=kt_id,
            include_content=include_content,
        )

        duplicate_knowledge_topic.additional_properties = d
        return duplicate_knowledge_topic
