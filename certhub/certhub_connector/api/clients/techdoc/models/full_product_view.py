...
T = TypeVar("T", bound="FullProductView")
...
class FullProductView:
    ...
    Attributes:
        ...
        product_families (list[FullProductFamilyView] | Unset):
        knowledge_units (list[FullKnowledgeUnitView] | Unset):
    ...
    product_families: list[FullProductFamilyView] | Unset = UNSET
    knowledge_units: list[FullKnowledgeUnitView] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _product_families is not UNSET:
            ...
            for product_families_item_data in _product_families:
                product_families_item = FullProductFamilyView.from_dict(
        ...
        if _knowledge_units is not UNSET:
            ...
            for knowledge_units_item_data in _knowledge_units:
                knowledge_units_item = FullKnowledgeUnitView.from_dict(
        ...
        full_product_view.additional_properties = d
        return full_product_view
