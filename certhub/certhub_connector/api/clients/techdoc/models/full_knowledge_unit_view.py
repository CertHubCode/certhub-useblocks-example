...
T = TypeVar("T", bound="FullKnowledgeUnitView")


@_attrs_define
class FullKnowledgeUnitView:
    """
    Attributes:
        ...
        knowledge_topics (list[KnowledgeTopic] | Unset):
    ...
    knowledge_topics: list[KnowledgeTopic] | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if _knowledge_topics is not UNSET:
            ...
            for knowledge_topics_item_data in _knowledge_topics:
                knowledge_topics_item = KnowledgeTopic.from_dict(
        ...
        full_knowledge_unit_view.additional_properties = d
        return full_knowledge_unit_view
