...
T = TypeVar("T", bound="CreateKnowledgeTopicFromExisting")


@_attrs_define
class CreateKnowledgeTopicFromExisting:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_knowledge_topic_from_existing = cls(
            kt_schema_id=kt_schema_id,
            kt_id=kt_id,
            include_content=include_content,
        )

        create_knowledge_topic_from_existing.additional_properties = d
        return create_knowledge_topic_from_existing
